        ...
        if (
          ...
          if ("fixed" === a || "absolute" === a) {
            ...
            l.indexOf("ms") + 1
              ...
              : l.indexOf("s") + 1 &&
                ((l = 1e3 * parseFloat(l.replace("s", ""))), o.push(l));
            ...
            var p =
                (i &&
                  parseFloat(getComputedStyle(i).getPropertyValue("zoom"))) ||
                1,
              h = t.scrollBarWidth / p,
              w =
                "100%" === s ||
                s === window.innerWidth + "px" ||
                s === window.innerWidth - t.scrollBarWidth + "px" ||
                "100vw" === s ||
                n.classList.contains("t-menu-popover_fullwidth") ||
                (n.classList.contains("t-menu-popover") && p > 1),
              f =
                "100%" === c ||
                c === window.innerHeight + "px" ||
                c === window.innerHeight - t.scrollBarWidth + "px" ||
                "auto" === c ||
                "100vh" === c;
            (!d && 0 !== d) || "auto" === n.style.right || "absolute" === a || w
              ? w &&
                !f &&
                (n.style.width =
                  "calc(100vw / " +
            ...
            document
              ...
              .insertAdjacentHTML(
                ...
                '<div class="t-tildalabel t-tildalabel-free" style="display: block !important; visibility: visible !important; position: relative !important; width: 100% !important; pointer-events: all !important; opacity: 1 !important; margin: 0 !important; z-index: 99900 !important"><div class="t-tildalabel-free__main"><a href="https://tilda.cc" target="_blank" style="padding-bottom:12px; display: block;"><img style="width:40px;" src="https://static.tildacdn.' +
                  t_getRootZone() +
                  '/img/tildacopy.png"></a><div style="padding-bottom: 15px;">This site was made on <a href="https://tilda.cc" target="_blank" style="text-decoration: none; color:inherit;">Tilda — a website builder</a> that helps to&nbsp;create a&nbsp;website without any code</div><a href="https:// registration/" target="_blank" style="display: inline-block; padding: 10px 20px; font-size: 13px; border-radius: 50px; background-color: #fa8669; color: #fff; text-decoration: none;">Create a website</a></div><div class="t-tildalabel-free__links-wr"><a class="t-tildalabel-free__txt-link" href="https://help' +
                  ("RU" === window.browserLang ? "-ru" : "") +
                  '. white-label" target="_blank">' +

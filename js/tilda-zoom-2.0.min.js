...
function t_zoom__createCloseBtn() {
  ...
  return (
    t.classList.add("t-zoomer__close", "t-zoomer__ui-item"),
...
function t_zoom__createScaleBtn() {
  var t = document.createElement("div");
  return (
    t.classList.add("t-zoomer__scale", "t-zoomer__ui-item"),
      ...
      if (t_getZoomState().isOpen)
        switch (t.key) {
          case "Escape":
            ...
            break;
          case "ArrowLeft":
            (t.preventDefault(), t_zoom__setEventOnBtn("prev"));
            break;
          case "ArrowRight":
            (t.preventDefault(), t_zoom__setEventOnBtn("next"));
        }
    }));
  var r =
...
function t_zoom__playAnimatedOpen(t, e) {
  ...
  function r(e) {
    ...
    ((r.src = e), r.classList.add("t_zoomer__animated-image"));
    var a = i(t),
      c = a.top,
      s = a.left,
      l = a.width,
  ...
  function a(t, e) {
    "IMG" !== t.tagName || (t.complete && t.offsetHeight && t.offsetWidth)
  ...
  function i(t) {
    var e = t.getBoundingClientRect(),
      ...
      s;
    if (
      ((o += window.scrollY), (r += window.scrollX), t_getZoomState().isSafari)
    ) {
      var l = c(t);
      ((o *= l), (r *= l), (n *= l), (a *= l));
    }
...
function t_zoom_openGallery(t) {
  ...
  if (!e.isOpen) {
    ...
    (s.appendChild(_),
      ...
      i && i.appendChild(c));
    var u = t.closest(".r"),
      f = document.querySelector(".t-carousel__zoomer__track"),
      v;
    if (f && u)
      (t_zoom__addingImgsIntoCarousel(t),
        t_zoom__setModalColors(u, t),
        t_zoom__showActiveSlideOnInit(t),
        t_zoom__playAnimatedOpen(
          t,
          f.querySelector(".t-carousel__zoomer__item.active img"),
        ),
        ...
        o && (t_zoom_initSwipe(), t_zoom_initCloseSwipe()),
        (window.tzoomopenonce = !0));
  }
}
function t_zoom__updateActiveSlidePos() {
  var t, e;
  t_getZoomState().isOpen &&
    setTimeout(function () {
...
function t_zoom_createSliderArrow(t) {
  ...
  var r = document.createElement("div");
  return (
    r.classList.add("t-zoomer__ui-item"),
    ...
    window.tzoomopenonce ||
      ...
      o.on("panend", function (o) {
        ...
        if ("y" !== a && "y" !== i && 1 === o.maxPointers && !n) {
          r.style.transition = "";
          var c = Math.abs(o.velocityX),
            s = r.offsetLeft,
            l = t[0].offsetWidth,
            d = r.querySelector(".t-carousel__zoomer__item.active").offsetLeft,
            _,
            m = (l - Math.abs(s + d)) / c / 1e3;
  ...
  function r() {
    (t && clearTimeout(t),
      ...
      (t = setTimeout(function () {
        var e, o;
        (n(t_getZoomState().isOpen ? "add" : "remove"), (t = 0));
      }, 2e3)));
  }
  function n(t) {
    var e = "t-zoomer__hide-animation",
      o;
    document
      .querySelectorAll(".t-zoomer__ui-item, .t-zoomer__comments")
      .forEach(function (o) {
...
function t_zoom__initSingleZoom() {
  ...
  1 === document.querySelectorAll(".t-carousel__zoomer__item").length &&
    document
      .querySelectorAll(".t-carousel__zoomer__control")
      .forEach(function (t) {
...
function t_zoom__addingImgsIntoCarousel(t) {
  var e = t.closest(".r"),
    o,
    r = t_getZoomState().hasLazy,
    n = ".t-zoomable:not(.t-slds__thumbs_gallery):not(.tn-atom__slds-img)",
    a = (null == e ? void 0 : e.querySelectorAll(n)) || [],
    i;
  if (e ? e.querySelector(".t-slds") : null) {
    var c = t.closest(".t-slds");
    (c && (a = c.querySelectorAll(".t-zoomable:not(.t-slds__thumbs_gallery)")),
      c &&
        c.querySelector(".tn-elem__gallery__video-wrapper") &&
        (a = Array.from(a)).splice(-1, 1));
  }
  ...
  Array.from(a).forEach(function (t, e) {
    ...
    (("IMG" !== t.nodeName && "DIV" !== t.nodeName) ||
      ...
      i &&
        ((_ = document.createElement("div")).classList.add(
          "t-zoomer__descr",
          "t-descr",
          "t-descr_xxs",
        ),
        ...
        null != s &&
          s.descrFontFamily &&
          (_.style.fontFamily = s.descrFontFamily)));
...
function t_zoom__showActiveSlideOnInit(t) {
  var e,
    ...
    a = document.querySelectorAll(".t-carousel__zoomer__item");
  if (n && a.length) {
    (a.forEach(function (t, e) {
      return t.setAttribute("data-zoomer-slide-number", e);
    }),
      a.length > 1 && t_zoom_loopSlider());
    var i = t.getAttribute("data-img-zoom-url"),
      c,
      s =
        ...
        i +
        '"]',
      l = i && document.querySelector(s),
      d = null == l ? void 0 : l.closest(".t-carousel__zoomer__item");
    (d &&
...
function t_zoom_showSlide(t) {
  ...
  function m() {
    if (
      (d.classList.add("active"),
      (e.style.transform = "translateX(" + -_ + "px)"),
      t_zoom__hideInnactiveSlides(d, e),
      t_zoom_checkForScale(),
      a)
    ) {
      e.removeAttribute("data-cached-zoom");
      var t = new Event("transitionend");
      e.dispatchEvent(t);
    }
    if (s) {
      (t_zoom__preloadNextSlide(d, e),
        t_onFuncLoad("t_lazyload_update", t_lazyload_update));
      var o = d.querySelector("img");
      o &&
        !o.src &&
        setTimeout(function () {
          t_onFuncLoad("t_lazyload_update", t_lazyload_update);
...
function t_zoom_transitForLoop(t) {
  var e,
    o = t_getZoomState().hasLazy,
    r = document.querySelector(".t-carousel__zoomer__track"),
    n = document.querySelectorAll(".t-carousel__zoomer__item"),
    a,
    i;
  t &&
    ("start" === t && (a = n.length - 2),
    "end" === t && (a = 1),
    (i = n[a].offsetLeft),
...
function t_zoom_loopSlider() {
  ...
  var t,
    ...
    r = Array.from(o.querySelectorAll(".t-carousel__zoomer__item"));
  o.addEventListener("transitionend", function () {
    ...
    (!e ||
      (0 !== t && t !== r.length - 1) ||
      t_zoom_transitForLoop(0 === t ? "start" : "end"),
    ...
    "y" !== e.getAttribute("data-on-drag") ||
      ...
      (t.deltaY < -200 || t.velocityY < -0.3
        ? ((e.style.transform = "translateY(-100vh)"),
          setTimeout(function () {
            (t_zoom_close(!0), (e.style.transform = ""));
          }, o))
        : t.deltaY > 200 || t.velocityY > 0.3
          ? ((e.style.transform = "translateY(100vh)"),
            setTimeout(function () {
...
function t_zoom_checkToScaleInit(t) {
  ...
  !t.src.includes(".svg") || window.isIE || c
    ? o < s || e < l
      ? (!a && n && t_zoom_doubletapScaleInit(), t_zoom_scale_init())
      : (document
          .querySelector(".t-zoomer__scale")
          .classList.add("t-zoomer__scale--disabled"),
        i.classList.add("zoomer-no-scale"))
  ...
  fetch(r)
    ...
    .then(function (r) {
      ...
      var c = n.querySelector("svg"),
        ...
        d = s / l,
        _ = 5e3;
      (s > _ && ((s = _), (l = Math.round(s / d))),
        t.setAttribute("data-original-svg-width", s),
        t.setAttribute("data-original-svg-height", l));
      var m = e < l || o < s,
        u = c.getAttribute("width"),
        f = c.getAttribute("height"),
        v;
      (((u || f) && !m) ||
        ((t.style.width = s + "px"), (t.style.height = l + "px")),
        m
          ? (!i && a && t_zoom_doubletapScaleInit(), t_zoom_scale_init())
          : document
              .querySelector(".t-zoomer__scale")
              .classList.add("t-zoomer__scale--disabled"),
      ...
      t.addEventListener(
        ...
        function (e) {
          ...
          if (o.isOpen) {
            ...
            ((r && e.target.closest(".t-zoomer__scale") && s) ||
              (!r &&
                s &&
                !e.target.closest(
                  ".t-zoomer__close, .t-carousel__zoomer__control",
                ))) &&
              (i.setAttribute("data-on-transition", ""),
              ...
              t.classList.contains("scale-active")
                ...
                : (t.classList.add("scale-active"),
                  ...
                  r
                    ? t_zoom_mobileZoomPositioningInit(a)
                    : t_zoom_desktopZoomPositioningInit(a, e)));
          }
        },
        !1,
      )));
...
function t_zoom_desktopZoomPositioningInit(t, e) {
  var o,
    r = t_getZoomState().isMobile,
    n = (window.innerWidth - t.offsetWidth) / 2,
    a = (window.innerHeight - t.offsetHeight) / 2,
    i,
    c,
    s,
    l,
    d = t.getAttribute("data-original-svg-width") || t.naturalWidth,
    _ = t.getAttribute("data-original-svg-height") || t.naturalHeight;
  function m(t, e) {
    ((s =
  ...
  ((t.style.left = n + "px"),
    (t.style.top = a + "px"),
    window.innerWidth < d && window.innerHeight < _
      ? ((s = (100 * e.clientX) / window.innerWidth),
...
function t_zoom_close(t) {
  ...
  var e = document.querySelector(".t-zoomer__wrapper");
  if (
    (e && e.dispatchEvent(new Event("zoom:close")),
  ...
  function n() {
    ...
    (document.body.classList.remove("t-zoomer__show", "t-zoomer__active"),
      null == (t = document.querySelector(".t_zoomer__animated-wrapper")) ||
        t.remove());
...
function t_zoom__processScrollLock(t) {
  var e = "t-body_scroll-locked",
    o = "data-popup-scrolltop",
    r,
    n;
...
function t_zoom__getThemePreset(t, e) {
  (void 0 === t && (t = "#ffffff"), void 0 === e && (e = !1));
  var o = "#ffffff",
    r = "#000000",
    n,
    a =
      ...
      t_zoom_luma_rgba(
        t.includes("-gradient(")
          ? t_zoom_getFirstColorFromGradient(t)
          : t_zoom_hexToRGBA(t),
      ),
    i = t;
  return (
    e || (i = a ? r : o),
    { isDark: a, bgColor: i, textColor: a ? o : r }
  );
}
function t_zoom__getModalColors(t, e) {
  var o,
    r = getComputedStyle(document.body)
      .getPropertyValue("--t-zoom-gallery-bg-color")
      .trim();
  if (r) return t_zoom__getThemePreset(r, !0);
  var n = t.getAttribute("data-bg-color") || "#ffffff",
    a;
...
function t_zoom__setModalColors(t, e) {
  ...
  if (i) {
    ...
    ((i.style.background = r), (i.style.color = n));
    var l = a ? "add" : "remove";
...
function t_zoom_luma_rgba(t) {
  if (!t || !Array.isArray(t) || t.length < 3) return "black";
  var e = t[0],
    o = t[1],
    r = t[2],
    n = t.length >= 4 ? t[3] : 1,
...
function t_zoom_hexToRGBA(t) {
  ...
  if (r && r[1]) {
    var a = r[1],
      i;
    n = (
      window.getComputedStyle(document.body).getPropertyValue(a) || r[2]
    ).trim();
  }
  var c =
  ...
  if (c)
    return [
      ...
      parseInt(c[2], 10),
      parseInt(c[3], 10),
      void 0 !== c[4] ? parseFloat(c[4]) : 1,
    ];
  var m = /^#?([a-f0-9]{2})([a-f0-9]{2})([a-f0-9]{2})([a-f0-9]{2})$/i.exec(n),
    u,
    f,
    v,
    p;
  ...
  var g = /^#?([a-f0-9]{2})([a-f0-9]{2})([a-f0-9]{2})$/i.exec(n),
    h,
    z,
    y;
  if (g) return [parseInt(g[1], 16), parseInt(g[2], 16), parseInt(g[3], 16), 1];
  var w = /^#?([a-f0-9])([a-f0-9])([a-f0-9])$/i.exec(n),
    S,
    b,
    L;
  if (w)
  ...
  var x = /^#?([a-f0-9])([a-f0-9])([a-f0-9])([a-f0-9])$/i.exec(n),
    A,
    C,
    E,
    q;
...
function t_zoom_getFirstColorFromGradient(t) {
  ...
  if (i) {
    var c,
      s = window.getComputedStyle(document.body).getPropertyValue(i);
    if (s) {
      var l =

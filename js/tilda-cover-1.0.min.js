...
function t_cover__setCoverParams(e, t, o) {
  ...
  if (
    ...
    var d = t_cover__getPureHeight(e),
      _ = t_cover__isScaled(e);
    if (d < window.innerHeight) {
      var u,
        l = d + 0.2 * window.innerHeight + "px";
      e.style.height = _ ? "calc(" + l + " / var(--t-zoom, 1))" : l;
    }
    t_cover__parallax(e);
  }
  if (i && t["cover-bg"] && !o) {
...
function t_cover__isScaled(e) {
  var t = null == e ? void 0 : e.closest(".t-record_scaled");
  if (!t) return !1;
  var o = t.querySelector("[data-content-cover-height]"),
    r = null == o ? void 0 : o.getAttribute("data-content-cover-height");
  return r && r.includes("vh");
}
...
function t_cover__recalcCoverHeight(e, t) {
  ...
  if (o) {
    var r = t_cover__isScaled(o),
      n = o.querySelector(".t-cover"),
      i =
        o.getAttribute("data-parenttplid") ||
        o.getAttribute("data-record-type");
    if (n && "935" !== i) {
      var c = o.querySelector(".t-cover__carrier"),
        a = c ? c.getAttribute("data-content-cover-height") : "";
      if (!a) {
        var d = o.querySelector("[data-content-cover-height]");
        a = d ? d.getAttribute("data-content-cover-height") : "";
      }
      var _ = "y" === o.getAttribute("data-fixed-bg"),
        u = [
          ".t-cover",
          ".t-cover__filter",
          ".t-cover__carrier",
      ...
      ("734" === i || o.querySelector(".t734")) &&
        u.push(".t-slds__items-wrapper");
      var l = "dynamic" === c.getAttribute("data-content-cover-parallax"),
        v = t_cover__getHeightFromAttr(a);
      if (v) {
        var s = Math.round(v) + "px",
          g = r ? "calc(" + s + " / var(--t-zoom, 1))" : s;
        u.forEach(function (e) {
          var t;
      ...
      var f = t_cover__getHeightFromAttr(a),
        p = t_cover__getPureHeight(n),
        h = f || p;
      if (!_) {
        var m = n.style.height;
        ((n.style.height = ""), (h = p), m && (n.style.height = m));
      }
      var y = t_cover__getContentHeight(o),
        b = 40,
        w = 300,
        H = !!c && "100vh" === c.getAttribute("data-content-cover-height");
      (y > w && h < y + b) ||
      _ ||
      ((window.t_cover__isMobile || "ontouchend" in document) && t)
        ? (t_cover__setRecalculatedHeight(o, y), t_cover__updateResizeElem(o))
        : window.t_cover__isMobile && H
          ? u.forEach(function (e) {
          ...
          : h > y + b &&
            (t_cover__setRecalculatedHeight(o, y),
...
function t_cover__setRecalculatedHeight(e, t) {
  ...
  (d || _) && ((u = 0), (l = 0));
  var v = t_cover__isScaled(e),
    s = (v && parseFloat(getComputedStyle(e).getPropertyValue("zoom"))) || 1;
  v
    ? ((t *= s), (t += u / s) > 1e3 && (t += l / s))
    : (t += u) > 1e3 && (t += l);
  var g = t > i ? t : i,
  ...
  ((d || e.querySelector(".t734")) && p.push(".t-slds__items-wrapper"),
    v && t === g && (g /= s));
  var h = v && g === i;
  (p.forEach(function (t) {
    ...
    Array.prototype.slice.call(e.querySelectorAll(t)).forEach(function (e) {
      if (
        ...
        f = 0.2 * document.documentElement.clientHeight;
        var t = g + f + "px";
        e.style.height = h ? "calc(" + t + " / var(--t-zoom, 1))" : t;
      } else
        e &&
          (e.style.height = h
            ? "calc(" + g + "px / var(--t-zoom, 1))"
            : g + "px");
    });
  }),
    o.setAttribute("data-content-cover-updated-height", g + f + "px"));
  var m = document.createEvent("Event");
  (m.initEvent("coverHeightUpdated", !0, !0), o.dispatchEvent(m));
}

  ...
  function _(e, t, r, n, o, i, c, l, u, f, p) {
      ...
      if (
        (u
          ? (f || w
              ...
              : (j[A] = m),
            f || _setFunctionName(j[A], n, O ? "" : A))
          : f || (j = Object.getOwnPropertyDescriptor(e, n)),
        !f && !u)
      ) {
        if ((s = v[+l][n]) && 7 != (s ^ o))
          throw Error(
    ...
    for (var D = e, T = h.length - 1; T >= 0; T -= r ? 2 : 1) {
      ...
      if (_)
        ...
        (D = I.call(x, w ? { get: j.get, set: j.set } : j[A], F)),
        (C.v = 1),
        w)
      ) {
        if ("object" == typeof D && D)
          ((s = g(D.get, "accessor.get")) && (j.get = s),
            (s = g(D.set, "accessor.set")) && (j.set = s),
            (s = g(D.init, "accessor.init")) && k.unshift(s));
        else if (void 0 !== D)
          throw new TypeError(
            "accessor decorators must return an object with get, set, or init properties or undefined",
          );
      } else
        g(D, (f ? "field" : "method") + " decorators", "return") &&
          (f ? k.unshift(D) : (j[A] = D));
    }
    return (
      o < 2 && c.push(b(k, l, 1), b(i, l, 0)),
      f ||
        _ ||
        (u
          ? w
            ? c.splice(-1, 0, S("get", l), S("set", l))
            : c.push(O ? j[A] : g.call.bind(j[A]))
          : y(e, n, j)),
      D
    );
  }
  function w(e) {
    return y(e, d, { configurable: !0, enumerable: !0, value: a });
  }
  return (
    void 0 !== i && (a = i[d]),
    (a = h(null == a ? null : a)),
...
function _asyncGeneratorDelegate(e) {
  ...
  function n(t, n) {
    return (
      ...
      { done: !1, value: new _OverloadYield(n, 1) }
    );
  }
  return (
...
function _coalesceClassElements(e) {
  for (
    var t = [],
      r = function (e) {
        return (
          "method" === e.kind && e.key === i.key && e.placement === i.placement
        );
      },
      n = 0;
    n < e.length;
    ...
    if ("method" === i.kind && (o = t.find(r)))
      if (_isDataDescriptor(i.descriptor) || _isDataDescriptor(o.descriptor)) {
        if (_hasDecorators(i) || _hasDecorators(o))
          throw new ReferenceError(
...
function _jsx(e, t, r, n) {
  ...
  if ((t || 0 === i || (t = { children: void 0 }), 1 === i)) t.children = n;
  else if (i > 1) {
...
function _regeneratorRuntime() {
  ...
  function u(e, t, r, n) {
    var i = t && t.prototype instanceof m ? t : m,
      ...
      s = new T(n || []);
    return (o(a, "_invoke", { value: j(e, r, s) }), a);
  }
  function f(e, t, r) {
    try {
    ...
    d: function () {
      ...
      function a() {
        for (; (n = r.pop()); )
          try {
            if (!n.a && 1 === i)
              return ((i = 0), r.push(n), Promise.resolve().then(a));
            if (n.d) {
              var e = n.d.call(n.v);
...
function old_memberDec(e, t, r, n, o, i, a, s, c) {
  ...
  var u,
    ...
    d = { v: !1 };
  if (
    (0 !== i && (p.addInitializer = old_createAddInitializerMethod(o, d)), s)
  ) {
    ((u = 2), (f = Symbol(t)));
    var y = {};
    (0 === i
  ...
  try {
    return e(
      c,
      Object.assign(p, old_createMetadataMethodsForProperty(n, u, f, d)),
    );
  } finally {
    d.v = !0;
  }
...
function old_applyMemberDec(e, t, r, n, o, i, a, s, c) {
  ...
  if (
      ...
      ? (0 === o || 1 === o
          ...
          : 3 === o
            ...
            : 4 === o
              ...
              : (l = { value: r[3] }),
        0 !== o &&
          (1 === o && _setFunctionName(r[4], "#" + n, "set"),
          _setFunctionName(r[3], "#" + n, f)))
      : 0 !== o && (l = Object.getOwnPropertyDescriptor(t, n)),
    1 === o
      ? (p = { get: l.get, set: l.set })
      : 2 === o
        ? (p = l.value)
        : 3 === o
          ? (p = l.get)
    ...
    void 0 !== (d = old_memberDec(v, n, l, s, c, o, i, a, p)) &&
      (old_assertValidReturnValue(o, d),
      0 === o
        ? (u = d)
        : 1 === o
          ? ((u = old_getInit(d)),
    ...
    for (var m = v.length - 1; m >= 0; m--) {
      var b;
      void 0 !== (d = old_memberDec(v[m], n, l, s, c, o, i, a, p)) &&
        (old_assertValidReturnValue(o, d),
        0 === o
          ? (b = d)
          : 1 === o
...
function _applyDecs(e, t, r) {
  var n = [],
    ...
    i = {};
  return (
    old_applyMemberDecs(n, e, i, o, t),
    old_convertMetadataMapToFinal(e.prototype, i),
    old_applyClassDecs(n, e, o, r),
...
function applyDecs2203Factory() {
  ...
  function t(t, r, n, o, i, a, s, c) {
    ...
    var u,
      f,
      p = { kind: l, name: s ? "#" + r : r, static: a, private: s },
      d = { v: !1 };
    (0 !== i && (p.addInitializer = e(o, d)),
      0 === i
        ? s
          ? ((u = n.get), (f = n.set))
          : ((u = function () {
      ...
      (p.access = u && f ? { get: u, set: f } : u ? { get: u } : { set: f }));
    try {
      return t(c, p);
    } finally {
      d.v = !0;
            ...
            0 === a || 1 === a
              ...
              : 3 === a
                ...
                : 4 === a
                  ? { set: o[3] }
                  : { value: o[3] })
        : 0 !== a && (u = Object.getOwnPropertyDescriptor(r, i)),
      1 === a
        ? (p = { get: u.get, set: u.set })
        : 2 === a
          ? (p = u.value)
          : 3 === a
            ? (p = u.get)
...
function applyDecs2203RFactory() {
        ...
        ? (0 === a || 1 === a
            ...
            : 3 === a
              ...
              : 4 === a
                ...
                : (u = { value: o[3] }),
          0 !== a &&
            (1 === a && _setFunctionName(o[4], "#" + i, "set"),
            _setFunctionName(o[3], "#" + i, p)))
        : 0 !== a && (u = Object.getOwnPropertyDescriptor(r, i)),
      1 === a
        ? (d = { get: u.get, set: u.set })
        : 2 === a
          ? (d = u.value)
          : 3 === a
            ? (d = u.get)
  ...
  function i(e, t) {
    for (
      var r, n, i = [], s = new Map(), c = new Map(), l = 0;
      l < t.length;
      l++
    ) {
      var u = t[l];
...
function applyDecs2301Factory() {
  ...
  function a(e, t, n, a, s, c, l, u, f) {
    ...
    if (
      ...
      for (var w = _.length - 1; w >= 0; w--) {
        var P;
        void 0 !== (m = r(_[w], a, p, u, s, c, l, h, f)) &&
          (o(s, m),
          0 === s
            ? (P = m)
            : 1 === s
  ...
  function s(e, t, r) {
    for (
      var n, o, i, s = [], l = new Map(), u = new Map(), f = 0;
      f < t.length;
      f++
    ) {
      var p = t[f];
...
function _applyDecs2305(e, t, r, n, o, i) {
  ...
  function l(e, t, r, n, o, i, s, l, u, f, p, d, y) {
    ...
    if (!g) {
      ...
      f
        ? (p || d
            ...
            : (_[P] = b),
          p || _setFunctionName(_[P], n, 2 === o ? "" : P))
        : p || (_ = Object.getOwnPropertyDescriptor(e, n));
    }
    for (var E = e, O = m.length - 1; O >= 0; O -= r ? 2 : 1) {
      ...
      try {
        if (g)
          (v = c(S.call(j, E, A), "class decorators", "return")) && (E = v);
        else {
          var D, T;
          ((A.static = u),
            (A.private = f),
          ...
          if (
            (D && (I.get = D),
            T && (I.set = T),
            (E = S.call(j, d ? { get: _.get, set: _.set } : _[P], A)),
            d)
          ) {
            if ("object" == typeof E && E)
              ((v = c(E.get, "accessor.get")) && (_.get = v),
                (v = c(E.set, "accessor.set")) && (_.set = v),
    ...
    return (
      ...
      p ||
        ...
        (f
          ? d
            ? l.push(a(_, "get"), a(_, "set"))
            : l.push(2 === o ? _[P] : a.call.bind(_[P]))
  ...
  if (arguments.length >= 6)
    var f = i[Symbol.metadata || Symbol.for("Symbol.metadata")];
  ...
  return (
    r.length || u(e, p),
    {
      ...
      get c() {
        var t = [];
        return (
          r.length && [u(l(e, [r], n, e.name, 5, p, t), p), s.bind(null, t, e)]
        );
      },
    }
  );
        ...
        if (t) {
          ...
          if (r) {
            ...
            if (i && !a) {
              ...
              (s.open("GET", t),
                ...
                (s.onreadystatechange = function () {
                  if (
                    ...
                    var o,
                      i = s.response.querySelector("svg"),
                      a;
                    if (!i) return;
                    i.querySelectorAll("*:not(g):not(title):not(desc)").forEach(
                      function (e) {
                        e.style.fill = r;
                      },
                    );
                    for (
                      var c = new XMLSerializer().serializeToString(i),
                        l = c.matchAll(
                          /var\((--uc-color-color-[a-zA-Z0-9]+),\s*[a-fA-F0-9#]+\)/g,
                        ),
                        u = window.getComputedStyle(document.body),
                        f = _createForOfIteratorHelperLoose(l),
                        p;
                      !(p = f()).done;
                    ) {
                      var d = p.value,
              ...
              n ? (e.src = t) : (e.style.backgroundImage = "url(" + t + ")");
          }
        }
      });
  }

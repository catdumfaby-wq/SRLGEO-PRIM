    ...
    for (
      ...
      if (!l(u)) {
        ...
        var E = !h.length && !g.length,
          A = "checkbox" === y || "radio" === y,
          F = r.querySelectorAll('[name="' + b + '"]:checked').length,
        ...
        if (x || "radio" === y) {
          var S = x ? "checkbox" : "radio",
            ...
            T =
              C &&
              C.querySelector(
                ".t-input__own-answer-input, .t-" + S + "-ownanswer",
              );
          if (T && T.checked) {
          ...
          switch (m) {
            case "email":
              ((f =
                ...
                h.length && !h.match(f) && v.type.push("email"));
              break;
            case "url":
              if (
                ((f =
                ...
                if (
                  (_ = (_ =
                    (_ = h.split("//")) && _.length > 1 ? _[1] : _[0]).split(
                    "/",
                  )) &&
                  _.length &&
                  _[0]
                  ...
                  if (!(_ = _[0]).match(f)) {
                    ...
                    _.match(I) || v.type.push("url");
                  }
                } else (_ && !_[0]) || v.type.push("url");
              break;
            case "phone":
              var j = u.getAttribute("data-tilda-mask"),
                D = "^[0-9()+-";
              (j &&
                (-1 !== j.indexOf("*")
                  ? (D += "a-zёа-я")
                  : (-1 !== j.indexOf("a") && (D += "a-z"),
                    -1 !== j.indexOf("а") && (D += "а-яё"))),
                (D += "]+$"),
                (f = new RegExp(D, "gi")),
                ((g.length && !g.match(f)) ||
            ...
            case "number":
              ((f = /^[0-9]+$/gi),
                g.length > 0 && !g.match(f) && v.type.push("number"));
              break;
            case "date":
              ...
              break;
            case "time":
              ((f = /^[0-9]{2}[:\.][0-9]{2}$/gi), //! TODO: 00:00 - 23:59. Заменить на
                g.length > 0 && !g.match(f) && v.type.push("time"));
              break;
            case "name":
              ((f =
                ...
                h.length && !h.match(f) && v.type.push("name"));
              break;
            case "nameeng":
              ((f = /^([A-Za-z\s]{1,}((\-)?[A-Za-z\.\s](\')?){0,})*$/i),
                h.length && !h.match(f) && v.type.push("nameeng"));
              break;
            case "namerus":
              ((f = /^([А-Яа-яЁё\s]{1,}((\-)?[А-Яа-яЁё\.\s](\')?){0,})*$/i),
                h.length && !h.match(f) && v.type.push("namerus"));
              break;
            case "string":
              ((f =
                ...
                h.length && !h.match(f) && v.type.push("string"));
              break;
            case "chosevalue":
              var M, P, q, R, B;
              if (
                "SELECT" ===
                (null == (e = u) ? void 0 : e.tagName.toUpperCase())
              )
                (null == (P = u) ? void 0 : P.value.length) > 0 ||
                  v.type.push("chosevalue");
              else
                "true" ===
                  (null == (R = u)
                    ? void 0
                    : R.getAttribute("data-option-selected")) ||
                  v.type.push("chosevalue");
              break;
            case "promocode":
              "y" !== i ||
    ...
    if ("y" === i) {
      ...
      if (O)
        if (
          ...
          var H = { obj: {}, type: [] };
          (H.type.push("minorder"), n.push(H));
        }
      if (V && window.tcart.total < window.tcart_mincntorder) {
        var U = { obj: {}, type: [] };
        (U.type.push("minquantity"), n.push(U));
      }
    }
    return (
      a &&
...
function t_forms__getMsg(t) {
  ...
  return (
    ...
    (e.RU = {
      ...
      req: "Vă rugăm să completați toate câmpurile obligatorii.",
      reqfield: "Câmp obligatoriu",
